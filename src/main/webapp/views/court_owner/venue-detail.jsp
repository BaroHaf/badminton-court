        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/court-owner/detail" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<%= venue.getId() %>">

                            <div class="col-12">
                                <label for="yourUsername" class="form-label">Tên sân cầu</label>
                                <div class="input-group has-validation">
                                    <input type="text" name="name" class="form-control" id="yourUsername" required value="<%=venue.getName()%>">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" name="address" class="form-control" id="address" required value="<%=venue.getAddress()%>">
                                    <div class="invalid-feedback">Nhập tên sân cầu.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    <input type="time" name="openTime" class="form-control" id="openTime" required value="<%=venue.getOpenTime()%>">
                                    <div class="invalid-feedback">Nhập tên sân cầu.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    <input type="time" name="closeTime" class="form-control" id="closeTime" required value="<%=venue.getCloseTime()%>">
                                    <div class="invalid-feedback">Nhập tên sân cầu.</div>
                                </div>
                            </div>
                            <a href="<%=request.getContextPath()%>/<%=venue.getImage()%>" target="_blank" class="btn btn-primary m-1">
                                Xem ảnh
                            </a>
                            <div class="col-12">
            ...
            <div class="col-7">
                <div class="card">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#createCourt" class="btn btn-success w-25 m-1">Thêm sân</button>
                    <div class="card-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<%=request.getContextPath()%>/court-owner/court?court_id=<%= court.getId() %>">
                                        <button type="submit" class="btn btn-sm <%= court.isAvailable() ? "btn-success" : "btn-danger" %>">
                            ...
                            %>
                            <tr>
                                <td colspan="5" class="text-center">No courts available.</td>
                            </tr>
                            <%
                                }
                            %>
